...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { email: @pessoa.email, is_monitor: @pessoa.is_monitor, nascimento: @pessoa.nascimento, nome: @pessoa.nome }
    end
  ...
  test "should update pessoa" do
    put :update, id: @pessoa, pessoa: { email: @pessoa.email, is_monitor: @pessoa.is_monitor, nascimento: @pessoa.nascimento, nome: @pessoa.nome }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
